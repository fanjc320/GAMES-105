...
def bonus_inverse_kinematics(meta_data, joint_positions, joint_orientations, left_target_pose, right_target_pose):
    ...
    metadata_right = task2_inverse_kinematics.MetaData(joint_name, joint_parent, joint_initial_position,
    ...
    while max_times > 0:
        ...
        for i in range(1, len(lpath)):
            ...
            orientation_matrix = euler_angles_to_matrix(cur_orientation, 'XYZ') @ euler_angles_to_matrix(
                lrotation_chain_tensor[i], 'XYZ')
        ...
        for i in range(len(rpath1)):
            ...
            rorientation_matrix = euler_angles_to_matrix(rcur_orientation, 'XYZ') @ euler_angles_to_matrix(
                rrotation_chain_tensor[i], 'XYZ')
    ...
    if 0 in lpath and rootjoint_index_in_lpath != 0:
        ...
        for i in range(1, rootjoint_index_in_lpath + 1):
            ...
            rootjoint_ori = matrix_to_euler_angles(
                euler_angles_to_matrix(rootjoint_ori, 'XYZ') @ euler_angles_to_matrix(lrotation_chain_tensor[i], 'XYZ'),
                'XYZ')
